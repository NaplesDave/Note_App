...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModelFactory = NoteViewModelFactory((application as
                NoteApplication).repository)
        ...
        // swipe operations on the notes list
        ...
        }).attachToRecyclerView(recyclerView)  // End ItemTouchHelper
    ...
    fun showDialogMessage(){
        ...
        dialogMessage.setMessage("If click Yes all notes will delete, if you " +
                "want to delete a specific note, please swipe Left or Right")
