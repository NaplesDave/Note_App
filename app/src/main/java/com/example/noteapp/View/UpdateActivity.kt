...
class UpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonCancel.setOnClickListener {
            // show the user that it saved nothing
            Toast.makeText(applicationContext, "Nothing updated", Toast
                .LENGTH_LONG).show()
            // close the intent , return to list view
            finish()
        } // end button Cancel action

        buttonSave.setOnClickListener {
            updateNote()
        } // end buttonSave action
